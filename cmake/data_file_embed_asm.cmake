#
# Convert a file (text or binary) into an assembler source file suitable for gcc. Designed to replicate 'objcopy' with
# more predictable naming, and supports appending a null byte for embedding text as a string.
#
# Designed to be run as a script with "cmake -P"
#
# Set variables DATA_FILE, SOURCE_FILE, FILE_TYPE when running this.
#
# If FILE_TYPE is set to TEXT, a null byte is appended to DATA_FILE's contents before SOURCE_FILE is created.
#
# If FILE_TYPE is unset (or any other value), DATA_FILE is copied verbatim into SOURCE_FILE.
#
if (NOT DATA_FILE)
