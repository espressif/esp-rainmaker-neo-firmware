 ...
 * @param[in] pCommandToSend Pointer to element to send to queue.
 ...
 *
 * @param[in] pMsgCtx An MQTTAgentMessageContext_t.
 * @param[out] pReceivedCommand Pointer to buffer to write received data.
